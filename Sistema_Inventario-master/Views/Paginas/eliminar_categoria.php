<?php 
	...
	$datosCategoria = $controlador->obtenerCategoriaController();
...
<div class="card page-header p-0" style="background-color: #FFCDCC">
    <div class="card-block front-icon-breadcrumb row align-items-end">
        <div class="breadcrumb-header col">
            ...
            <div class="d-inline-block"> <!-- Se muestra la categoria que será eliminado -->
                <h5> Eliminar categoria: <strong> <?php echo $datosCategoria["nombre"]; ?> </h5>
                <span> Eliminar </span>
            </div>
        </div>
        <div class="col">
...
<div class="page-body">
    <div class="card">
        <div class="card-block">            
            ...
            <!-- FORM PARA ELIMINAR CATEGORIA (Solo se ingresa la contraseña)-->
            <form method="POST">
